...
//        metricsByIndividualYear
        ...
        metricsResultByFiveYears.coalesce(1).saveAsTextFile("output/YearPrediction/ByFiveYearsMetrics/"+ Instant.now().toEpochMilli());
        metricsResultByYear.coalesce(1).saveAsTextFile("output/YearPrediction/ByIndividualYearsMetrics/"+ Instant.now().toEpochMilli());
        metricsResultByTenYears.coalesce(1).saveAsTextFile("output/YearPrediction/ByTenYearsMetrics/"+ Instant.now().toEpochMilli());
