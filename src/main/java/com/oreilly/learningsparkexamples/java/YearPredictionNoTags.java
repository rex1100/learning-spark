...
public class YearPredictionNoTags {

    public static void main(String[] args) throws Exception {
        YearPredictionNoTags logisticR = new YearPredictionNoTags();
    ...
    public static void run(String master) {
        ...
        JavaRDD<LabeledPoint> dataByIndividualYear = decadeTextData.map(YearPrediction::createEnhancedSongInfo)
                .map((EnhancedSongInfo song) -> {
                    ...
                    points[0] = song.getArtistHotttnesss();
                    points[1] = song.getArtistFamiliarity();
                    points[2] = song.getDuration();
                    ...
                    return new LabeledPoint(yearMapped, Vectors.dense(points));
                });
