...
public class YearPredictionTags {
    ...
    public static void run(String master) {
        ...
        metricsResultByFiveYears.coalesce(1).saveAsTextFile("output/YearPredictionTags/ByFiveYearsMetrics/"+ Instant.now().toEpochMilli());
        metricsResultByYear.coalesce(1).saveAsTextFile("output/YearPredictionTags/ByIndividualYearsMetrics/"+ Instant.now().toEpochMilli());
        metricsResultByTenYears.coalesce(1).saveAsTextFile("output/YearPredictionTags/ByTenYearsMetrics/"+ Instant.now().toEpochMilli());
